...
{
    [MaxLibVlcVersion("1.1.50", "invmem (fake input)", Replacement = "IMemoryInputMedia or ICompositeMemoryInputMedia")]
    internal sealed unsafe class VideoInputMedia : BasicMedia, IVideoInputMedia
    {
        ...
        public void AddFrame(Bitmap frame)
        {
            ...
            try
            {
                ...
                NativeMethods.CopyMemory(m_data.pPixelData, pData, m_data.size);
