...
namespace Implementation.Players
{
    internal class AudioPlayer : BasicPlayer, IAudioPlayer
    {
        ...
        public void SetAudioOutputModuleAndDevice(AudioOutputModuleInfo module, AudioOutputDeviceInfo device)
        {
            ...
            if (res < 0)
            {
                throw new LibVlcException("Failed to set audio output device");
            }
        }
        ...
        public void SetEqualizer(Equalizer equalizer)
        {
            ...
            int res = LibVlcMethods.libvlc_media_player_set_equalizer(m_hMediaPlayer, equalizer.Handle);
            if (res != 0)
                throw new LibVlcException("Failed to set audio equalizer");
        }
    }
}
