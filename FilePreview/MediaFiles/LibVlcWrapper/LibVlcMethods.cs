...
namespace LibVlcWrapper
{
    ...
    public static class LibVlcMethods
    {
        ...
        [DllImport("libvlc", CallingConvention = CallingConvention.Cdecl)]
        public static extern IntPtr libvlc_media_new_callbacks(IntPtr p_mi, IntPtr open_cb, IntPtr read_cb, IntPtr seek_cb, IntPtr close_cb, IntPtr opaque);

        [MinimalLibVlcVersion("3.0.0")]
        [DllImport("libvlc", CallingConvention = CallingConvention.Cdecl)]
        public static extern libvlc_media_type_t libvlc_media_get_type(IntPtr p_mi);

        [MinimalLibVlcVersion("3.0.0")]
        [DllImport("libvlc", CallingConvention = CallingConvention.Cdecl)]
        public static extern int libvlc_media_parse_with_options(IntPtr p_mi, libvlc_media_parse_flag_t parse_flag, int timeout);

        [MinimalLibVlcVersion("3.0.0")]
        [DllImport("libvlc", CallingConvention = CallingConvention.Cdecl)]
        public static extern void libvlc_media_parse_stop(IntPtr p_mi);

        [MinimalLibVlcVersion("3.0.0")]
        [DllImport("libvlc", CallingConvention = CallingConvention.Cdecl)]
        public static extern libvlc_media_parsed_status_t libvlc_media_get_parsed_status(IntPtr p_mi);

        [MinimalLibVlcVersion("3.0.0")]
        [DllImport("libvlc", CallingConvention = CallingConvention.Cdecl)]
        public static extern IntPtr libvlc_media_get_codec_description(libvlc_track_type_t i_type, uint i_codec );

        [MinimalLibVlcVersion("3.0.0")]
        [DllImport("libvlc", CallingConvention = CallingConvention.Cdecl)]
        public static unsafe extern int libvlc_media_player_get_full_title_descriptions(IntPtr p_mi, libvlc_title_description_t*** titles);

        [MinimalLibVlcVersion("3.0.0")]
        [DllImport("libvlc", CallingConvention = CallingConvention.Cdecl)]
        public static unsafe extern void libvlc_title_descriptions_release(libvlc_title_description_t** p_titles, int i_count);

        [MinimalLibVlcVersion("3.0.0")]
        [DllImport("libvlc", CallingConvention = CallingConvention.Cdecl)]
        public static unsafe extern int libvlc_media_player_get_full_chapter_descriptions(IntPtr p_mi,
                                                                  int i_chapters_of_title,
                                                                  libvlc_chapter_description_t*** pp_chapters);

        [MinimalLibVlcVersion("3.0.0")]
        [DllImport("libvlc", CallingConvention = CallingConvention.Cdecl)]
        public static unsafe extern void libvlc_chapter_descriptions_release(libvlc_chapter_description_t** p_chapters, int i_count);

        [MinimalLibVlcVersion("3.0.0")]
        [DllImport("libvlc", CallingConvention = CallingConvention.Cdecl)]
        public static extern int libvlc_media_slaves_add(IntPtr p_md, libvlc_media_slave_type_t i_type, uint i_priority,
                             [MarshalAs(UnmanagedType.LPArray)] byte[] psz_mr);

        [MinimalLibVlcVersion("3.0.0")]
        [DllImport("libvlc", CallingConvention = CallingConvention.Cdecl)]
        public static extern void libvlc_media_slaves_clear(IntPtr p_md);

        [MinimalLibVlcVersion("3.0.0")]
        [DllImport("libvlc", CallingConvention = CallingConvention.Cdecl)]
        public static unsafe extern uint libvlc_media_slaves_get(IntPtr p_md, libvlc_media_slave_t*** ppp_slaves);

        [MinimalLibVlcVersion("3.0.0")]
        [DllImport("libvlc", CallingConvention = CallingConvention.Cdecl)]
        public static unsafe extern void libvlc_media_slaves_release(libvlc_media_slave_t** pp_slaves, uint i_count);
        ...
        [MinimalLibVlcVersion("3.0.0")]
        [DllImport("libvlc", CallingConvention = CallingConvention.Cdecl)]
        public static extern IntPtr ibvlc_media_discoverer_new(IntPtr p_inst, [MarshalAs(UnmanagedType.LPArray)] byte[] psz_name);

        [MinimalLibVlcVersion("3.0.0")]
        [DllImport("libvlc", CallingConvention = CallingConvention.Cdecl)]
        public static extern int libvlc_media_discoverer_start(IntPtr p_mdis);

        [MinimalLibVlcVersion("3.0.0")]
        [DllImport("libvlc", CallingConvention = CallingConvention.Cdecl)]
        public static extern void libvlc_media_discoverer_stop(IntPtr p_mdis);

        [MinimalLibVlcVersion("3.0.0")]
        [DllImport("libvlc", CallingConvention = CallingConvention.Cdecl)]
        public static unsafe extern uint libvlc_media_discoverer_list_get(IntPtr p_inst,
                                  libvlc_media_discoverer_category_t i_cat,
                                  libvlc_media_discoverer_description_t*** ppp_services);

        [MinimalLibVlcVersion("3.0.0")]
        [DllImport("libvlc", CallingConvention = CallingConvention.Cdecl)]
        public static unsafe extern void libvlc_media_discoverer_list_release(libvlc_media_discoverer_description_t** pp_services, uint i_count);
        ...
        [MinimalLibVlcVersion("2.2.0")]
        [DllImport("libvlc", CallingConvention = CallingConvention.Cdecl)]
        public static extern double libvlc_audio_equalizer_get_band_frequency( int u_index );
        ...
        [MinimalLibVlcVersion("2.2.0")]
        [DllImport("libvlc", CallingConvention = CallingConvention.Cdecl)]
        public static extern int libvlc_audio_equalizer_set_preamp( IntPtr p_equalizer, double f_preamp );

        [MinimalLibVlcVersion("2.2.0")]
        [DllImport("libvlc", CallingConvention = CallingConvention.Cdecl)]
        public static extern double libvlc_audio_equalizer_get_preamp(IntPtr p_equalizer);

        [MinimalLibVlcVersion("2.2.0")]
        [DllImport("libvlc", CallingConvention = CallingConvention.Cdecl)]
        public static extern int libvlc_audio_equalizer_set_amp_at_index(IntPtr p_equalizer, double f_amp, int u_band);

        [MinimalLibVlcVersion("2.2.0")]
        [DllImport("libvlc", CallingConvention = CallingConvention.Cdecl)]
        public static extern double libvlc_audio_equalizer_get_amp_at_index( IntPtr p_equalizer, int u_band );
        ...
        [MinimalLibVlcVersion("2.2.0")]
        [DllImport("libvlc", CallingConvention = CallingConvention.Cdecl)]
        public static extern IntPtr libvlc_audio_output_device_enum(IntPtr p_mi);

        [MinimalLibVlcVersion("3.0.0")]
        [DllImport("libvlc", CallingConvention = CallingConvention.Cdecl)]
        public static extern IntPtr libvlc_audio_output_device_get(IntPtr p_mi);

        [MinimalLibVlcVersion("3.0.0")]
        [DllImport("libvlc", CallingConvention = CallingConvention.Cdecl)]
        public static extern libvlc_media_player_role libvlc_media_player_get_role(IntPtr p_mi);

        [MinimalLibVlcVersion("3.0.0")]
        [DllImport("libvlc", CallingConvention = CallingConvention.Cdecl)]
        public static extern int libvlc_media_player_set_role(IntPtr p_mi, libvlc_media_player_role role);

        [MinimalLibVlcVersion("3.0.0")]
        [DllImport("libvlc", CallingConvention = CallingConvention.Cdecl)]
        public static extern int libvlc_media_player_set_renderer(IntPtr p_mi, IntPtr p_item);

        [MinimalLibVlcVersion("3.0.0")]
        [DllImport("libvlc", CallingConvention = CallingConvention.Cdecl)]
        public static extern int libvlc_media_player_add_slave(IntPtr p_mi, libvlc_media_slave_type_t i_type,
                                   [MarshalAs(UnmanagedType.LPArray)] byte[] psz_uri, bool b_select );

        [MinimalLibVlcVersion("3.0.0")]
        [DllImport("libvlc", CallingConvention = CallingConvention.Cdecl)]
        public static unsafe extern libvlc_video_viewpoint_t* libvlc_video_new_viewpoint();

        [MinimalLibVlcVersion("3.0.0")]
        [DllImport("libvlc", CallingConvention = CallingConvention.Cdecl)]
        public static unsafe extern int libvlc_video_update_viewpoint(IntPtr p_mi, libvlc_video_viewpoint_t* p_viewpoint, bool b_absolute);
        ...
        [DllImport("libvlc", CallingConvention = CallingConvention.Cdecl)]
        [MinimalLibVlcVersion("3.0.0")]
        public static extern void libvlc_media_list_player_set_pause(IntPtr p_mlp, int do_pause);
        ...
        [MinimalLibVlcVersion("3.0.0")]
        [DllImport("libvlc", CallingConvention = CallingConvention.Cdecl)]
        public static extern IntPtr libvlc_media_list_player_get_media_player(IntPtr p_mlp);
        ...
        #region libvlc_dialog

        [MinimalLibVlcVersion("3.0.0")]
        [DllImport("libvlc", CallingConvention = CallingConvention.Cdecl)]
        public static extern void libvlc_dialog_set_callbacks(IntPtr p_instance, libvlc_dialog_cbs p_cbs, IntPtr p_data);

        [MinimalLibVlcVersion("3.0.0")]
        [DllImport("libvlc", CallingConvention = CallingConvention.Cdecl)]
        public static extern void libvlc_dialog_set_context(IntPtr p_id, IntPtr p_context);

        [MinimalLibVlcVersion("3.0.0")]
        [DllImport("libvlc", CallingConvention = CallingConvention.Cdecl)]
        public static extern IntPtr libvlc_dialog_get_context(IntPtr p_id);

        [MinimalLibVlcVersion("3.0.0")]
        [DllImport("libvlc", CallingConvention = CallingConvention.Cdecl)]
        public static extern int libvlc_dialog_post_login(IntPtr p_id, 
            [MarshalAs(UnmanagedType.LPArray)] byte[] psz_username,
            [MarshalAs(UnmanagedType.LPArray)] byte[] psz_password, bool b_store);

        [MinimalLibVlcVersion("3.0.0")]
        [DllImport("libvlc", CallingConvention = CallingConvention.Cdecl)]
        public static extern int libvlc_dialog_post_action(IntPtr p_id, int i_action);

        [MinimalLibVlcVersion("3.0.0")]
        [DllImport("libvlc", CallingConvention = CallingConvention.Cdecl)]
        public static extern int libvlc_dialog_dismiss(IntPtr p_id);

        #endregion

        #region libvlc_renderer_discoverer.h

        [MinimalLibVlcVersion("3.0.0")]
        [DllImport("libvlc", CallingConvention = CallingConvention.Cdecl)]
        public static extern IntPtr libvlc_renderer_item_hold(IntPtr p_item);

        [MinimalLibVlcVersion("3.0.0")]
        [DllImport("libvlc", CallingConvention = CallingConvention.Cdecl)]
        public static extern void libvlc_renderer_item_release(IntPtr p_item);

        [MinimalLibVlcVersion("3.0.0")]
        [DllImport("libvlc", CallingConvention = CallingConvention.Cdecl)]
        public static extern IntPtr libvlc_renderer_item_name(IntPtr p_item);

        [MinimalLibVlcVersion("3.0.0")]
        [DllImport("libvlc", CallingConvention = CallingConvention.Cdecl)]
        public static extern IntPtr libvlc_renderer_item_type(IntPtr p_item);

        [MinimalLibVlcVersion("3.0.0")]
        [DllImport("libvlc", CallingConvention = CallingConvention.Cdecl)]
        public static extern IntPtr libvlc_renderer_item_icon_uri(IntPtr p_item);

        [MinimalLibVlcVersion("3.0.0")]
        [DllImport("libvlc", CallingConvention = CallingConvention.Cdecl)]
        public static extern int libvlc_renderer_item_flags(IntPtr p_item);

        [MinimalLibVlcVersion("3.0.0")]
        [DllImport("libvlc", CallingConvention = CallingConvention.Cdecl)]
        public static extern IntPtr libvlc_renderer_discoverer_new(IntPtr p_inst, [MarshalAs(UnmanagedType.LPArray)] byte[] psz_name);

        [MinimalLibVlcVersion("3.0.0")]
        [DllImport("libvlc", CallingConvention = CallingConvention.Cdecl)]
        public static extern void libvlc_renderer_discoverer_release(IntPtr p_rd);

        [MinimalLibVlcVersion("3.0.0")]
        [DllImport("libvlc", CallingConvention = CallingConvention.Cdecl)]
        public static extern int libvlc_renderer_discoverer_start(IntPtr p_rd);

        [MinimalLibVlcVersion("3.0.0")]
        [DllImport("libvlc", CallingConvention = CallingConvention.Cdecl)]
        public static extern void libvlc_renderer_discoverer_stop(IntPtr p_rd);

        [MinimalLibVlcVersion("3.0.0")]
        [DllImport("libvlc", CallingConvention = CallingConvention.Cdecl)]
        public static extern IntPtr libvlc_renderer_discoverer_event_manager(IntPtr p_rd);

        [MinimalLibVlcVersion("3.0.0")]
        [DllImport("libvlc", CallingConvention = CallingConvention.Cdecl)]
        public static extern unsafe uint libvlc_renderer_discoverer_list_get(IntPtr p_inst, libvlc_rd_description_t*** ppp_services);

        [MinimalLibVlcVersion("3.0.0")]
        [DllImport("libvlc", CallingConvention = CallingConvention.Cdecl)]
        public static extern unsafe void libvlc_renderer_discoverer_list_release(libvlc_rd_description_t** pp_services, uint i_count);
