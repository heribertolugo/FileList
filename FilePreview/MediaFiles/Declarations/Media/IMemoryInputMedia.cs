...
{
    /// <summary>
    /// Represents single elementary stream (audio, video, subtitles or data) of frames insertion into VLC engine.
    /// Based on imem access module.
    /// </summary>
    /// <remarks>For multiple streams use ICompositeMemoryInputMedia</remarks>
    public interface IMemoryInputMedia : IMedia
    {
        ...
        /// <summary>
        /// Gets value indication whether current media instance initialized.
        /// </summary>
