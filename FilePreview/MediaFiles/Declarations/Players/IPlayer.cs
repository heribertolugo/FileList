...
namespace Declarations.Players
{
    ...
    public interface IPlayer : IDisposable, IEqualityComparer<IPlayer>
    {
        ...
        /// <summary>
        /// Stops the playback asynchronusly. 
        /// The function returns immediatly without waiting for the player to actually stop.
        /// </summary>
        /// <remarks>This function fixes ocasional deadlock issue within VLC when stopping player</remarks>
        Task StopAsync();

        /// <summary>
        /// Gets or sets media player role
        /// </summary>
        MediaPlayerRole Role { get; set; }
    }
}
