...
namespace Declarations.Players
{
    ...
    public interface IVideoPlayer : IAudioPlayer
    {
        ...
        /// <summary>
        /// Sets network renderer for the player.
        /// </summary>
        /// <param name="renderItem"></param>
        /// <remarks>List of renderer item is retreved from renderer discovery service</remarks>
        void SetNetworkRenderer(IRendererItem renderItem);

        /// <summary>
        /// 
        /// </summary>
        /// <param name="viewPoint"></param>
        void UpdateViewpoint(IViewPoint viewPoint);

        /// <summary>
        /// 
        /// </summary>
        /// <param name="slave"></param>
        void AddSlaveMedia(SlaveMedia slave);
    }
}
