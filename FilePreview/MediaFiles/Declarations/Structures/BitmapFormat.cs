...
namespace Declarations
{
    ...
    /// </summary> 
    [Serializable]
    [DebuggerDisplay("Width={Width}, Height={Height}, ChromaType={ChromaType}")]  
    public class BitmapFormat : IEquatable<BitmapFormat>
    {
        /// <summary>
        ...
        private void Init()
        {
            switch (ChromaType)
            {
                ...
                case ChromaType.DX11:
                case ChromaType.DXA9:
        ...
        public override bool Equals(object obj)
        {
            ...
            BitmapFormat format = obj as BitmapFormat;
            if (format == null)
                return false;
        ...
        {
            return this.Width.GetHashCode() ^ this.Height.GetHashCode() ^ this.ChromaType.GetHashCode();
        }
