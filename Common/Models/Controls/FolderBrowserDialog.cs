...
namespace Common.Models.Controls
{
    /// <summary>
    /// Author: Simon Mourier
    /// Website: https://stackoverflow.com/questions/15368771/show-detailed-folder-browser-from-a-propertygrid
    /// </summary>
    public class FolderBrowserDialog
    {
        ...
        public FolderBrowserDialog(IWin32Window owner) {
            this._owner = owner;
        }
        ...
        {
            if (this._owner == null)
                throw new NullReferenceException("Method can only be used when IWin32Window is specified in constructor.\nPlease use ShowDialog overload which allows IWin32Window");

            return this.ShowDialog(this._owner);
        }
