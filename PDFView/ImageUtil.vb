...
Public Class ImageUtil
    ...
    Public Shared Sub ScaleImage(ByRef img As Drawing.Image, ByVal scale_factor As Single)
        ...
        Dim bm_dest As New Drawing.Bitmap(
    ...
    Public Shared Sub PictureBoxZoomIn(ByRef pPicBox As PictureBox, ByVal zoomInButton As ToolStripItem)
        If Not Nothing Is pPicBox And Not Nothing Is pPicBox.Parent Then
            Dim zoomCount As Integer = 0
            If pPicBox.Tag IsNot Nothing Then
                zoomCount = CType(pPicBox.Tag, Integer)
            End If
            zoomCount += 1
            If zoomCount <= 5 Then
            ...
            pPicBox.Tag = zoomCount
        End If
    End Sub

    Public Shared Sub PictureBoxZoomOut(ByRef pPicBox As PictureBox, ByVal zoomInButton As ToolStripItem)
