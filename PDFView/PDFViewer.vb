...
Public Class PDFViewer
    ...
    Public Property AllowPrint As Boolean
        Get
            Return Me.tsPrint.Visible
        End Get
        Set(value As Boolean)
            Me.tsPrint.Visible = value
        End Set
    End Property

    Public Property AllowImportImages As Boolean
        Get
            Return Me.tsImport.Visible
        End Get
        Set(value As Boolean)
            Me.tsImport.Visible = value
        End Set
    End Property

    Public Property AllowExport As Boolean
        Get
            Return Me.tsExport.Visible
        End Get
        Set(value As Boolean)
            Me.tsExport.Visible = value
        End Set
    End Property
...
GhostScriptFallBack:
    ...
    Public Function PageCount(ByVal FileName As String) As Integer
        Return ImageUtil.GetImageFrameCount(FileName)
    End Function

    Public Function Print(ByVal FileName As String) As Integer
...
OCRCurrentImage:
        Try
            ''* These lines removed because they depend on tessnet2_32.dll
            ''* this dll is used for OCR and adds mmore work to convert this to 64 bit.
    ...
    Private Sub tsZoomOut_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tsZoomOut.Click
        ...
        ImageUtil.PictureBoxZoomOut(objPictureBox, tsZoomIn)
    ...
    Private Sub tsZoomIn_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tsZoomIn.Click
        ...
        'End If
        Dim objPictureBox As PictureBox = FindPictureBox(mCurrentPageNumber)
        ImageUtil.PictureBoxZoomIn(objPictureBox, tsZoomIn)
        objPictureBox.Refresh()
        'tscbZoom.Text = GetCurrentScalePercentage() & " %"
        DisplayCurrentPage()
    End Sub
    ...
    Private Function SearchCallBack(ByVal sender As Object, ByVal e As SearchArgs) As Integer
        ...
        If mPDFDoc IsNot Nothing Then
            ...
            Else
                ...
                lFound = mPDFDoc.FindText(e.Text, mPDFDoc.CurrentPage, (If(e.WholeDoc, PDFLibNet.PDFSearchOrder.PDFSearchFromdBegin, PDFLibNet.PDFSearchOrder.PDFSearchFromCurrent)), e.Exact, e.Up, True,
                 e.WholeDoc)
            End If
            If lFound > 0 Then
